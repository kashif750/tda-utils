const getEmailTemplateProductOrder = (template_key) => {
	let template = "";
	switch (template_key) {
              ...
              <tr>
                  ...
                  <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
                      ...
                      <td style="padding:30px;background-color:#ffffff;">
                          <h1 style="margin-top:0;margin-bottom:16px;font-size:26px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;">Tour de Amsterdam - Product Renting Invoice</h1>
                          <p style="margin:0;">Your Product Order is created and your order number is {{ orderNumber }}. Please click on <a href="{{ mollieUrl }}" style="color:#3BB0E5;text-decoration:underline;">this link</a>, to proceed with payment.</p>
                      </td>
                      </tr>
                      <tr>
                      <td style="text-align:center;padding:0 30px 11px 30px;font-size:0;background-color:#ffffff;border-bottom:1px solid #f0f0f5;border-color:rgba(201,201,207,.35);">
                          ...
                          <p style="margin:0;text-align:center;"><a href="{{ mollieUrl }}" style="background: #3BB0E5; text-decoration: none; padding: 10px 25px; color: #ffffff; border-radius: 4px; display:inline-block; mso-padding-alt:0;text-underline-color:#008c3c"><!--[if mso]><i style="letter-spacing: 25px;mso-font-width:-100%;mso-text-raise:20pt">&nbsp;</i><![endif]--><span style="mso-text-raise:10pt;font-weight:bold;">Mollie Payment Link</span><!--[if mso]><i style="letter-spacing: 25px;mso-font-width:-100%">&nbsp;</i><![endif]--></a></p>
                          </div>
                          <!--[if mso]>
                          </td>
                          </tr>
...
export default getEmailTemplateProductOrder;
